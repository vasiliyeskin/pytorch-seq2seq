...
Этот репозиторий содержит учебные материалы для понимания работы моделей глубоких нейронный сетей sequence-to-sequence (seq2seq) и из реализации с помощью [PyTorch](https://github.com/pytorch/pytorch) 1.8, [torchtext](https://github.com/pytorch/text) 0.9 и [spaCy](https://spacy.io/) 3.0,  под Python 3.8.
